...
const LineasPaginationTable = () => {
    ...
    React.useEffect(() => {
        const fetchLineas = async () => {
            try {
                const response = await axios.get(`${URL}lineasEstrategicas`);
    ...
    const handleEdit = (id) => {
        navigate(`/lineasEstrategicas/cambios/${id}`);
    };

    const handleDelete = async (row) => {
        try {
            await axios.put(`${URL}lineasEstrategicas/eliminar/${row.id}`);
    ...
    return (
        <DownloadCard title="Lineas Estrategicas" onDownload={handleDownload}>
...
export default LineasPaginationTable;
