...
const DepartamentosPaginationTable = () => {
    ...
    const handleEdit = (id) => {
        navigate(`/Departamentos/cambios/${id}`);  // Redirige a la página de cambios con el id
    };

    const handleViewDetails = (id) => {
        navigate(`/departamentos/detalle/${id}`);  // Redirige a la página de detalles con el id
    };
